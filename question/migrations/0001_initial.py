# Generated by Django 2.2.5 on 2019-11-10 12:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='all_submissions', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Media',
            fields=[
                ...
                ('file', models.FileField(null=True, upload_to=question.models.get_question_media_location)),
